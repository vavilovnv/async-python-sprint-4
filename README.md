![example workflow](https://github.com/vavilovnv/async-python-sprint-4/actions/workflows/app-testing.yml/badge.svg)  
...
1. Создать и заполнить .env файл по аналогии с .env_example
